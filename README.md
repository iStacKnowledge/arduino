...
| [**photoresistor**](./photoresistor/) | Dual LED light indicator and threshold detection using a photoresistor (LDR). | Analog voltage divider, LDR sensing, `analogRead()`, digital threshold switching. |
